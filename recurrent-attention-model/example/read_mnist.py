...
DATA_PATH = 'C:/Users/Rishikesh/Documents/Codes/IITM_neural_network_Assignment/recurrent-attention-model/example'


def original_mnist(batch_size=128, shuffle=False):
    ...
    train_data = MNISTData('train', data_dir=DATA_PATH, shuffle=False,
                           batch_dict_name=['data', 'label'], pf=preprocess_im)
    train_data.setup(epoch_val=0, batch_size=batch_size)
    valid_data = MNISTData('val', data_dir=DATA_PATH, shuffle=False,
                           batch_dict_name=['data', 'label'], pf=preprocess_im)
